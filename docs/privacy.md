...
- SQLCipher protects the database; its random key and provider credentials live in Keychain or
  Windows Credential Manager.
- External AI and local agent access are separate opt-in capabilities.
